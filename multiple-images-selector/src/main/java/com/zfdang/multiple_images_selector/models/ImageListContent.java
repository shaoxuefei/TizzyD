...
public class ImageListContent {
    ...
    public static final ArrayList<ImageItem> IMAGES = new ArrayList<ImageItem>();//展示的图片信息
    ...
    public static final ArrayList<String> SELECTED_IMAGES = new ArrayList<>();//默认的已选中的图片
