...
import com.shanlin.sxf.dialog.SoftInputDialog;

import butterknife.BindView;
import butterknife.ButterKnife;
import butterknife.OnClick;

public class NewDialogSoftInputKeyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_dialog_soft_input_key);
        ...
        softInputDialog = SoftInputDialog.newInstance();
    }

    @OnClick(R.id.tv_write)
    public void onViewClicked() {
        softInputDialog.show(getSupportFragmentManager(), "softDialog");
    }
